...
setwd("D:\\Surfdrive\\Project 1\\datapackage\\1_unconditional_model")
...
for(a in 1:nrow(scen.mat)){
  ...
  #Name for saving
  nam.out.save <- paste0(nam.out.data)
  ...
  write.table(list.out[[a]][[1]],paste0(nam.out.save,"rawZ.txt"))
  write.table(list.out[[a]][[2]],paste0(nam.out.save,"rawQ.txt"))
  write.table(list.out[[a]][[3]],paste0(nam.out.save,"poolZ.txt"))
  write.table(list.out[[a]][[4]],paste0(nam.out.save,"poolQ.txt"))
