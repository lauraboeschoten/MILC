...
# check by hand which cluster is which 
samples$LC1 <- lc1[,"Cluster.1"]
samples$LC2 <- lc2[,"Cluster.1"]
samples$LC3 <- lc3[,"Cluster.2"]
samples$LC4 <- lc4[,"Cluster.1"]
samples$LC5 <- lc5[,"Cluster.2"]
...
levels(new.samples$i1) <- c("huur","koop")
levels(new.samples$i2) <- c("huur","koop")
levels(new.samples$i3) <- c("huur","koop")
levels(new.samples$i4) <- c("huur","koop")
levels(new.samples$i5) <- c("huur","koop")
